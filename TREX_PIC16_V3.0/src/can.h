...
#define CANADDR_PC                      0x86UL
#define CANADDR_TRACTION                0x82UL
#define CANADDR_BRUSH                   0x83UL
#define CANADDR_VACUUM                  0x84UL
#define CANADDR_SIDEBROOM               0x85UL
#define CANADDR_CHARGER                 0x00UL
#define CANADDR_GLOBAL                  0xFFUL

#define CANADDR_VCM_SERIAL_NUMBER       0x90UL
#define CANADDR_HMI_SERIAL_NUMBER       0x91UL
#define CANADDR_PC_SERIAL_NUMBER        0x96UL
#define CANADDR_VCM_SERVICE_LOG         0xA0UL
#define CANADDR_HMI_SERVICE_LOG         0xA1UL
#define CANADDR_PC_SERVICE_LOG          0xA6UL
#define CANADDR_PC_MANUFACTURE_DATE     0xB6UL
#define CANADDR_HMI_MANUFACTURE_DATE    0xB1UL
...
/**
 * @brief      Revive CAN from low power mode
 */
