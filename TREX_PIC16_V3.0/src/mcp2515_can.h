...
#define CAN_REVERSE( VALUE )                                                                                           \
    ( ( VALUE >> 24U ) & 0XFFUL ) | ( ( VALUE >> 8U ) & 0XFF00UL ) | ( ( VALUE & 0XFF00UL ) << 8 ) |                   \
        ( ( VALUE & 0XFF ) << 24U )
#define CAN_SHIFT29( VALUE ) ( ( VALUE << 3 ) & 0XFFE00000UL ) | ( VALUE & 0X3FFFFUL )
#define CAN_MASK29( VALUE ) CAN_REVERSE( ( CAN_SHIFT29( VALUE ) ) )
#define CAN_FILTER29( VALUE ) CAN_REVERSE( ( CAN_SHIFT29( VALUE ) | 0X80000UL ) )
...
/**
 * @brief      Interrupt service routine to handle traffic to and from the chip
 */
