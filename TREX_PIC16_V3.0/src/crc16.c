 ...
 *
 * If CRC_RAM_TABLE is defined, the table is calculated upon initialization. Otherwise
 * a constant table is used.  This lets you decide whether you want the table to
 * consume RAM or FLASH memory.
 */
#include "crc16.h"
...
static const uint16_t _CRCTable[ CRC_TABLE_SIZE ] = {
