...
// Keep a count of errors (for debugging purposes)
extern unsigned int LSM6DS3_failedReadCounter;

//------------------------------//----------------------------------------------
// Public functions

/**
 * @brief      Power up and configure the IMU
 *
