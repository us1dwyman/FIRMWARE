...
#ifndef  DRV_NVM_M25P80_2_ChipSelectEnable
    #error "DRV_NVM_M25P80_2_ChipSelectEnable() is not defined. Please define in system_config.h."
#endif
#ifndef  DRV_NVM_M25P80_2_ChipSelectDisable
    #error "DRV_NVM_M25P80_2_ChipSelectDisable() is not defined. Please define in system_config.h."
#endif
...
void    DRV_NVM_M25P80_WriteEnable(bool chip_select_1);
void    DRV_NVM_M25P80_WriteByte(uint8_t data, uint32_t address, bool chip_select_1);
uint8_t DRV_NVM_M25P80_ReadByte(uint32_t address, bool chip_select_1);
uint8_t DRV_NVM_M25P80_WriteSector(uint32_t address, uint8_t *pData, uint16_t nCount, bool chip_select_1);
uint8_t DRV_NVM_M25P80_CheckWriteInProgress(bool chip_select_1);


#define DRV_NVM_M25P80_IsWriteBusy()        (ReadStatusRegister(chip_select_1) & 0x01)
...
******************************************************************************/
static inline __attribute__((__always_inline__)) uint8_t ReadStatusRegister(bool chip_select_1)
{
    uint8_t    temp;
    if(chip_select_1)
        DRV_NVM_M25P80_ChipSelectEnable();
...
******************************************************************************/
uint8_t DRV_NVM_M25P80_ReadStatusRegister(bool chip_select_1)
{
    uint8_t    temp;
    ...
    temp =  ReadStatusRegister(chip_select_1);
...
void DRV_NVM_M25P80_WriteByte(uint8_t data, uint32_t address,bool chip_select_1)
{
    DRV_NVM_M25P80_WriteEnable(chip_select_1);
...
//#ifdef ENABLE_M25P80_WRITE_VERIFICATION
    ...
    for(counter = 0; counter < nCount; counter++)
    {
        if(*pData != DRV_NVM_M25P80_ReadByte(address,chip_select_1))
        {
            ret = 0;
            break;
        }
...
/******************************************************************************
  ...
  Returns:
    ...
    0 - if the write was not successful
******************************************************************************/
uint8_t DRV_NVM_M25P80_Write(uint32_t address, uint8_t *pData, uint16_t nCount, bool chip_select_1)
{
    ...
    while(DRV_NVM_M25P80_CheckWriteInProgress(chip_select_1) == 1);
    ...
    for (counter = 0; counter < nCount; )
    {
        ...
        ret = DRV_NVM_M25P80_WriteSector(addr, pD, sendCount, chip_select_1);
        if (ret == 0)
            break;
        else
        {
...
/******************************************************************************
  ...
  Returns:
    None
******************************************************************************/
void DRV_NVM_M25P80_Read(uint32_t address, uint8_t *pData, uint16_t nCount, bool chip_select_1)
{
    while(!SPILOCK(spiInitData.channel));
...
/******************************************************************************
  ...
  Returns:
    None
 ******************************************************************************/
void DRV_NVM_M25P80_ChipErase(bool chip_select_1)
{
	// reset the BPL bits to be non-write protected, in case they are
    // write protected
    DRV_NVM_M25P80_WriteStatusRegister(0x00,chip_select_1);
...
/******************************************************************************
  ...
  Returns:
    None
******************************************************************************/
void DRV_NVM_M25P80_SectorErase(uint32_t address, bool chip_select_1)
{
...
/******************************************************************************
  ...
  Returns:
    None
******************************************************************************/
void DRV_NVM_M25P80_WriteStatusRegister(uint8_t newStatus, bool chip_select_1)
{
...
/******************************************************************************
  ...
  Returns:
    None	
******************************************************************************/
void DRV_NVM_M25P80_ReadIDRegister(uint8_t* pBuffer, bool chip_select_1)
{
